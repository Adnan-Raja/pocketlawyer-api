...
INSERT INTO lawyers (id, name, img, description, focus) VALUES (5, 'James Oliver', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQE1d0YWy8kf2dflPnFjgk-Pl_AP_SaeCGm7g&usqp=CAU.jpg','Civil rights lawyers handle cases involving charging the state or other authorities with violations of an individuals constitutional rights. Circumstances may include harassment, civil liberties, voting rights, human rights, or discrimination based on sex, race, age, religion, gender, national origin, physical or mental disability, sexual orientation, and more. In addition, civil rights lawyers secure the rights of individuals to the freedoms of expression, speech, movement, privacy, thought, religion, and the press.','Civil Rights Lawyer');
